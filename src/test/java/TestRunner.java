...
public class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  + ProcessingContextTest - Context architecture and runtime state");
        ...
        LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
                .selectors(
                    selectClass(ProcessingContextTest.class),
                    selectClass(ConfigurationManagerTest.class),
